...
# Reagent App + tailwind starter project
...
cd my-project
```
or just press cmnd + J to open up terminal in VSCode and you will be at the root of this project
...
### 4. Start the App
This will start the app in the browser, listen to tailwind changes and rebuild the CSS file and start a repl in the browser
```
npm run dev
```
...
### 6. Connect to the repl

```
press ctrl + alt + c two times
```
You will get a pop-up in VSCode that asks you to select what to connect to.  
1. Select "shadow-cljs" 
2. Select "browser-repl"

Now you can evaluate stuff directly in VS code by alt + ENTER on a form.
